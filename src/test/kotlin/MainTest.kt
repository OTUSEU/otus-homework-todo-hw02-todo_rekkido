...
class MainTest {
    ...
    fun checkFinishFilterAfterFinishTaskTest() {
        ...
        val lisOfCompletedTasks = testRepository.getTasks(completed = true).size
        assertEquals(1, lisOfCompletedTasks, "Expected 1 task in filter, but got $lisOfCompletedTasks")
...
//        println(" all true $listOfALLTasks active false $listOfActiveTasks ")
